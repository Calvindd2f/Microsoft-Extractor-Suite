...
-------           ------       ------ ---                            ----------                 -----------
Get-MgApplication Applications GET    /applications/{application-id} IMicrosoftGraphApplication {Applicati…
Get-MgApplication Applications GET    /applications                  IMicrosoftGraphApplication {Applicati…

find-MgGraphCommand -Command 'New-AzureADApplication'

   APIVersion: v1.0

Command           Module       Method URI           OutputType                 Permissions
-------           ------       ------ ---           ----------                 -----------
New-MgApplication Applications POST   /applications IMicrosoftGraphApplication {Application.ReadWrite.Owne…



find-MgGraphCommand -Command 'New-AzureADServiceAppRoleAssignment'

   APIVersion: v1.0

Command                                 Module       Method URI
-------                                 ------       ------ ---
New-MgServicePrincipalAppRoleAssignment Applications POST   /servicePrincipals/{servicePrincipal-id}/appRo…
